...
{
  /* get order details and dispatch data for the frontend to use */
}
...
/* Action to request previous order data from api */
...
export const deleteOrder = (orderId) => async (dispatch, getState) => {
  ...
  try {
    ...
    const message =
      error.response && error.response.data.message //this comes from orderRouter.delete
        ? error.response.data.message
        : error.message;
